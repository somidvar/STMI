...
public class MainActivity extends Activity
    ...
    private static Asset toAsset(File RawData) {
        Log.i(TAG,"------------------------------------------Welcome toAssest Function1");
        ...
        try{
            ...
            Log.e(TAG,"---------------------------------Error in toAsset Function "+e1.getMessage());
        }
        try{
            ...
            Log.e(TAG,"---------------------------------Error in toAsset Function "+e2.getMessage());
        }
        try{
            ...
            if (null != byteStream) {
                try {
                    ...
                    Log.e(TAG,"---------------------------------Error in toAsset Function "+e3.getMessage());
                }
            }
        }
    }
